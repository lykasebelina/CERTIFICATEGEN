    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-gray-900 px-4 sm:px-6 lg:px-8 py-2 shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <NavLink to="/features" className={navLinkClasses} onClick={() => setIsMenuOpen(false)}>FEATURES</NavLink>
          <NavLink to="/demo" className={navLinkClasses} onClick={() => setIsMenuOpen(false)}>DEMO</NavLink>
