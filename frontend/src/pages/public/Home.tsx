...
<div className="w-full h-screen relative overflow-hidden">
 ...
 <div className="absolute inset-0 flex items-start max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32">
  <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start w-full text-center sm:text-center lg:text-left">
  ...
  className="group bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-10 py-4 rounded-2xl text-xl font-semibold transform hover:scale-105 transition-all duration-200 shadow-2xl hover:shadow-cyan-500/25"
>
